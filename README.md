# fraud-detection-app
# Streamlit Anomaly Detection Application
...
```bash
git remote add origin https://github.com/YOUR_USERNAME/streamlit-anomaly-detection.git
```
...
```text
https://streamlit-anomaly-detection.streamlit.app
```
